...
- (void)customNavigationTitleView
{
    ...
    UILabel *label = [CMCustomViewFactory createLabel:CGRectMake(Num_Zero, 5, 100, 34) title:titleStr color:[UIColor whiteColor] font:[UIFont systemFontOfSize:22 *kAppScale] textAlignment:NSTextAlignmentCenter];
